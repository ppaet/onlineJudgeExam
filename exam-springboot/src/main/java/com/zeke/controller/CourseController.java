...
public class CourseController {
    ...
    @GetMapping
    public ApiResult<List<Course>> select(@NotNull Integer uId, String name, String courseCode) {
        return courseService.select(uId, name, courseCode);
    }
    ...
    public ApiResult<Object> studentQuitCourse(Integer uId, Integer cId) {
        return courseService.studentQuitCourse(uId, cId);
    }
